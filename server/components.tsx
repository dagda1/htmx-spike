...
export const renderer = jsxRenderer(({ children }) => {
  return html`
    ...
    <html>
      ...
      <body>
        <div class="p-4">
          <h1 class="text-4xl font-bold mb-4"><a href="/">something</a></h1>
          ${children}
        </div>
      </body>
    </html>
...
export const AddSomething = (): JSX.Element => (
  <form
    hx-post="/something"
    hx-target="#something"
    hx-swap="beforebegin"
...
export const Item = ({ title, id }: { title: string; id: string }): JSX.Element => (
  <p
    hx-delete={`/something/${id}`}
    hx-swap="outerHTML"
